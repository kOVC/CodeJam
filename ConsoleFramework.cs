/*
    ConsoleFramework.cs includes classes representing console applications 
	(both menu and prompt based). It aims to reduce the amount of attention
	a programmer pays to the plumping of the console interface and
	concentrate on code.
