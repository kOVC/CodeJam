/*
    IOFiles.cs includes two main classes. InputFile which facilitates reading 
	Google Code Jam competition input files/data. OutputFile facilitates writing 
	output data in a form compliant with the competion's standard output format
